...
- fix: the theme font `family` is applied to every text surface and to the text-drawing geoms; `element-geom` gains a `font` role inheriting the base `text` family. (#54)
