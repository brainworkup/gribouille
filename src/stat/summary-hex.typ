...
/// ```
/// //| alt: "Hexagonal grid of 25 cells per axis over a noisy spiral cloud where each cell's fill encodes the mean radius via stat-summary-hex layered onto geom-hex with the viridis palette."
/// #let n = 600
