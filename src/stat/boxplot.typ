...
///
/// One output row per distinct x value with keys `(x, lower, middle, upper,
/// ymin, ymax, outliers)`. `lower`, `middle`, and `upper` are the quartiles
/// of the input y values; `ymin` and `ymax` are the smallest and largest y
