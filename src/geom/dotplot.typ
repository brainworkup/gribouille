...
///
/// Bins observations along x (default 30 bins), then stacks them upward
/// inside each bin. The dot diameter is `binwidth * dotsize` in data units
/// on the x-axis; `stackratio` controls the vertical spacing between dots
/// (1 means dots touch).
///
/// \@category Geoms
/// \@stability stable
...
/// ```
///
/// \@see \@stat-bindot, \@geom-histogram
#let geom-dotplot(
  mapping: none,
  data: none,
  bins: 30,
